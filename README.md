...
- **Kufar — оценка выгодности.** По каждому запросу берём выборку лотов (до 200),
  ...
  - 🔥 **СУПЕРВЫГОДНО** — дешевле медианы на ≥35 %;
  - 🟢 **Выгодно** — на 15–35 % дешевле;
  - ⚪️ **Рынок** — в пределах ±15 %;
  - 🔺 **Дороговато** — дороже медианы;
...
```json
{
  "paused": false,
  "subscriptions": [
    { "id": "iphone", "source": "kufar", "enabled": true, "notify": "good",
      "label": "Айфоны", "query": "iphone", "cat": "17010", "rgn": "7", "tag": "айфоны" },
    { "id": "run", "source": "kufar", "enabled": true, "notify": "all",
      "label": "Беговые кроссовки 45–46", "query": "беговые кроссовки 46", "rgn": "7", "tag": "кроссовки" },
    { "id": "gpu", "source": "kufar", "enabled": true, "notify": "good",
      "label": "Видеокарты", "query": "видеокарта", "rgn": "7", "tag": "видеокарты" },
...
хэштег категории на карточках 🔥/🟢 (для поиска в чате); `cat` — категория
(`17010` = мобильные телефоны), `rgn` — область (**7** = Минск, **1** = Брестская,
**2** = Гомельская, **3** = Гродненская, **4** = Могилёвская, **5** = Витебская,
**6** = Минская область). Цена **не** ограничена — ищем во всех ценовых категориях;
при желании можно задать `min_byn`/`max_byn` в рублях. `private_only` — только
частники (по умолчанию выкл, шлём и частников, и компании).
