...
# Аксессуары и не-товары: ломают медиану и не являются целью поиска.
STOPWORDS = (
    "чехол", "чехлы", "стекло", "стёкла", "стекла", "дисплей", "экран",
    "запчаст", "ремонт", "обмен", "копия", "реплика", "аккумулятор", "батаре",
    "зарядк", "кабель", "разбит", "на запчасти", "не работает", "нерабоч",
)
